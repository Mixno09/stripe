 ...
 */
final class Version20231013145029 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE checkout_session (id INT NOT NULL, user_id INT DEFAULT NULL, session_id TEXT NOT NULL, mode VARCHAR(255) NOT NULL, sub_status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
